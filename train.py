...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_iterations", nargs="+", type=int, default=[1000*(i+1) for i in range(2)])
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[1000*(i+1) for i in range(2)])
